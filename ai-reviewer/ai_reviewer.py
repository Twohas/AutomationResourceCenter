...
llm_base_url = os.getenv("LLM_BASE_URL", "http://localhost:11434/v1")      # 예: "http://localhost:11434/v1" (Ollama)
llm_model_name = os.getenv("LLM_MODEL", "qwen2.5-coder:7b")    # 예: "llama3", "deepseek-coder", "qwen2.5-coder:7b"
